...
class TestStudentLists(TestCase):
    ...
    def test_remove_a_student_not_in_the_student_list(self):
        test_class = ClassList(2)
        test_class.add_student('Student A')
        test_class.add_student('Student B')
        with self.assertRaises(StudentError):
            test_class.remove_student('Student C')
    


    ## TODO write a test that removes a student from an 
    # empty list, and asserts a StudentError is raised
    def test_remove_student_when_student_list_is_empty(self):
        test_class = ClassList(2)
        with self.assertRaises(StudentError):
            test_class.remove_student('Sample Student')
    ...
    def test_is_enrolled_when_student_is_not_enrolled(self):
        test_class = ClassList(2)
        test_class.add_student('Student A')
        test_class.add_student('Student B')
    ...
    def test_is_class_full_when_is_empty(self):
        test_class = ClassList(2)
